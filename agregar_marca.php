...
<div class="row barra_fix">
  ...
  <div class="col" style="background-color: #FFFFFF">
      <?php
        if ($_SESSION['marca_msg']) {
          switch ($_SESSION['marca_msg']) {
            case 1:
              echo '<div class="row" style="margin: 2px">No se pudo agregar la marca<br>Verifique que no haya un marca con el mismo nombre e intentelo mas tarde</divr>';
              unset($_SESSION['marca_msg']);
              break;
            case 2:
              echo '<div class="row" style="margin: 2px">La marca se ha agregado exitosamente</div>';
              unset($_SESSION['marca_msg']);
              break;
          }
        }
    ...
    <div class="row" style="margin: 2px">
      ...
      <form action="marca_procesos.php" method="post">
      <!--Indicar agregar marca (1)-->
      <input type="text" style="display:none" name="marca" value="1">
      Nombre de la marca: <input type="text" name="nombre" required><br><br>
