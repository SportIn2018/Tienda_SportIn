...
<div class="row barra_fix">
  ...
  <div class="col" style="background-color: #FFFFFF">
    <div class="row" style="margin: 2px">
      <h2>Actualizar datos de usuario</h2><br>
      <?php
      if ($_SESSION['act_msg']) {
        switch ($_SESSION['act_msg']) {
          case 1:
            echo '</div><div class="row" style="margin: 2px">La operación no se puede realizar por que algunos de los datos no son validos, vuelva a intentarlo';
            unset($_SESSION['act_msg']);
            break;
          case 2:
            echo '</div><div class="row" style="margin: 2px">La operación no se puede realizar por que hubo un error al acceder a la base de datos, vuelva a intentarlo mas tarde';
            unset($_SESSION['act_msg']);
            break;
          case 3:
    ...
    <div class="row" style="margin: 2px">
      ...
      $query = ("SELECT us_nombre,us_apaterno,us_amaterno,us_direccion,us_telefono,us_correo FROM usuarios WHERE id_usuario = $uid");
      //Ejecutar consulta
      ...
      if (!$process) {
        ...
        $data = pg_fetch_array($process, 0);
      ?>
      <form action="registro_us.php" method="post">
      <!--Indicar actualizar usuario-->
      <input type="text" style="display:none" name="act_usuario" value="1">
      <h5>Datos Personales</h5>
      Nombre: <input type="text" name="nombre" value=<?php echo '"'.$data[0].'"'; ?> required><br><br>
      Apellido Paterno: <input type="text" name="apaterno" value=<?php echo '"'.$data[1].'"'; ?> required><br><br>
      Apellido Materno: <input type="text" name="amaterno" value=<?php echo '"'.$data[2].'"'; ?> ><br><br>
      Dirección: <input type="text" name="direccion" value=<?php echo '"'.$data[3].'"'; ?> required><br><br>
      Teléfono: <input type="text" name="telefono" value=<?php echo '"'.$data[4].'"'; ?> required><br><br>
      Correo: <input type="text" name="mail" value=<?php echo '"'.$data[5].'"'; ?> required><br><br>
