...
<div class="row barra_fix">
  ...
  <div class="col" style="background-color: #FFFFFF">
      <?php
        if ($_SESSION['categ_msg']) {
          switch ($_SESSION['categ_msg']) {
            case 1:
              echo '<div class="row" style="margin: 2px">No se pudo agregar la categoria<br>Verifique que no haya un categoria con el mismo nombre e intentelo mas tarde</div>';
              unset($_SESSION['categ_msg']);
              break;
            case 2:
              echo '<div class="row" style="margin: 2px">La categoria se ha agregado exitosamente</div>';
              unset($_SESSION['categ_msg']);
              break;
          }
        }
    ...
    <div class="row" style="margin: 2px">
      ...
      <form action="categoria_procesos.php" method="post">
      <!--Indicar agregar categoria (1)-->
      <input type="text" style="display:none" name="categoria" value="1">
      Nombre de la categoria: <input type="text" name="nombre" required><br><br>
